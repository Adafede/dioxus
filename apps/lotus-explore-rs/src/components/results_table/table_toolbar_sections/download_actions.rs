...
const TOOLBAR_LINK_CLASS: &str = "inline-flex shrink-0 min-h-8 items-center justify-center gap-1.5 rounded-sm border border-border bg-surface text-text font-semibold shadow-xs px-3 py-1.5 text-ui font-sans select-none transition-[background,border-color,box-shadow,transform] duration-150 cursor-pointer hover:bg-bg active:bg-bg active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40";
