...
pub(in crate::components::results_table::row_cells) fn taxon_cell(
    ...
    rsx! {
        td { class: "min-w-0 rounded-[10px] px-3 py-2 align-middle text-wd-taxon shadow-[inset_3px_0_0_var(--footer-wd-taxon)]",
            div { class: "flex flex-col gap-1",
                a {
                    href: "https://www.wikidata.org/entity/{taxon_qid}",
                    target: "_blank",
                    rel: "noopener noreferrer",
                    class: "block break-words font-semibold italic leading-snug hover:underline",
                    "{entry.taxon_name}"
                }
            }
