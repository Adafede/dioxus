...
pub(super) const TEXTAREA_130: &str =
    "form-textarea mono w-full min-h-[130px] rounded-lg border border-border bg-surface p-2.5 font-mono text-ui text-text shadow-xs focus:outline-none focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent/40";

pub(super) const TEXTAREA_220: &str =
    "form-textarea mono w-full min-h-[220px] rounded-lg border border-border bg-surface p-2.5 font-mono text-ui text-text shadow-xs focus:outline-none focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent/40";
