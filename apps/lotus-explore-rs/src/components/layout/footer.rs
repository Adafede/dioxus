...
const FOOTER_LINE: &str = "footer-line flex flex-col gap-3 py-1 border-b border-border last:border-b-0";
...
const FOOTER_LABEL: &str = "footer-label inline-flex items-center font-bold uppercase tracking-[0.06em] whitespace-nowrap leading-normal px-2 py-[3px] rounded-lg border border-[color-mix(in_srgb,currentColor_30%,var(--border))] border-l-4 border-current bg-[color-mix(in_srgb,currentColor_14%,var(--surface))] min-h-[44px] max-[480px]:whitespace-normal max-[480px]:text-micro max-[480px]:px-1.5 max-[480px]:py-[2px] max-[480px]:min-h-0";
...
const FOOTER_LINK: &str = "footer-link no-underline text-ui leading-[1.45] min-h-[44px] inline-flex items-center px-2 py-1 rounded-[2px] hover:underline hover:bg-[color-mix(in_srgb,currentColor_8%,var(--surface))] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--accent)] focus-visible:outline-offset-[var(--focus-ring-offset)] focus-visible:rounded-[2px] max-[480px]:px-1.5 max-[480px]:py-[3px] max-[480px]:text-micro max-[480px]:min-h-[40px]";
