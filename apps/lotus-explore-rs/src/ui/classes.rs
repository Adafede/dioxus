...
pub const INPUT: &str = "w-full rounded-md border border-border bg-surface px-3 py-2 text-body text-text placeholder:text-subtle shadow-xs transition-colors focus:outline-none focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent/40";

/// Compact number input inside range pairs.
pub const INPUT_SM: &str = "w-full rounded-sm border border-border bg-surface px-2 py-1.5 text-body text-text shadow-xs transition-colors focus:outline-none focus-visible:border-accent focus-visible:ring-2 focus-visible:ring-accent/40";
