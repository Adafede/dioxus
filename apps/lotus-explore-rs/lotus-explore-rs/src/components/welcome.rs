    ...
    div { class: "h-4" }
                    div { class: "px-4 sm:px-6",
                        Card {
                            ...
                            // Programmatic URLs - collapsible like SPARQL query panel
                            details {
    ...
    rsx! {
        div {
            ...
            input {
                ...
                value: "{absolute}",
                aria_label: "{format}",
                class: "min-w-0 flex-1 truncate rounded-md border border-border bg-surface px-2 py-1 font-mono text-ui text-muted shadow-xs focus:outline-none focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-accent/28 focus-visible:ring-offset-2",
            }
...
fn ExRow(value: &'static str, note: &'static str) -> Element {
    rsx! {
        li {
            ...
            span {
                class: "self-start rounded-full bg-accent/10 px-2 py-0.5 font-mono text-ui font-semibold text-accent",
                "{value}"
            }
            span {
