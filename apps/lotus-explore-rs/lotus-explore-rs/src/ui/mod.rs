...
//! LOTUS-specific UI composition primitives.
//!
//! Inlined from the shared `ui` crate to make lotus-explore-rs standalone.
//! Only the components and styles actually used by this app are included.
...
/// Re-export of commonly used UI primitives.
#[allow(unused_imports)]
pub mod prelude {
    pub use crate::ui::a11y_contract::{
        MAIN_PANEL_ID, PAGE_TITLE_ID, RESULTS_SECTION_HEADING_ID, RESULTS_SECTION_ID,
        SEARCH_PANEL_BODY_ID, SKIP_TO_RESULTS_HREF,
    };
    pub use crate::ui::common::{SKIP_LINK_STYLE, skip_link, skip_link_main};
    pub use crate::ui::document::{DocumentHead, DocumentLinks, DocumentScripts, LinkSpec};
    pub use crate::ui::notice::{NoticeBar, NoticeBarProps, NoticeTone};
    pub use crate::ui::segmented_control::{
        SegmentedControl, SegmentedControlItem, SegmentedControlProps,
    };
    pub use crate::ui::styles::lotus::tokens::*;
