...
//! Inline JavaScript bridge for RDKit.js + Ertl NP-likeness model.
//!
//! Embedded as a raw string constant and injected into the document
//! `<head>` by [`super::document_head::SmellfishDocumentHead`].  Keeping the
//! JS in one named file makes the bridge self-contained and testable as a
//! unit, rather than burying 400 lines of JS inside a Rust component.
